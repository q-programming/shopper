    ...
    <table class="main">
        ...
        <tr>
            <td>
                ...
                <div>
                    <p>
                        Połaczyłeś nowe urządzenie ze swoim kontem w aplikacji Shopper. Aby potwierdzić to urządzenie , proszę kliknij link poniżej.<br>
                        Jeżeli nie możesz przejśc bezpośrednio, skopiuj i wklej link do przeglądarki
                    </p>
                    <p>
